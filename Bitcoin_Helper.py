...
"""encode_base58(s)
    Description: converts a public key in bytes to an address in bytes
    inputs:
        s: a public key in SEC format
    outputs:
        An address to the public key in Base58 format
"""
def encode_base58(s):
    count = 0
    for c in s:  # <1>
...
"""read_varint(s):
    inputs: stream, s
    outputs: returns the integer encoded containing the number of inputs for the Tx
"""
def read_varint(s):
