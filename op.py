...
def op_checksig(stack, z):
    ...
    der_signature = stack.pop()[:-1]# the next element of the stack is the DER signature 
    # take off the last byte of the signature as that's the hash_type
    try:
        point = S256Point.parse(sec_pubkey)# parse the serialized pubkey and signature into objects
